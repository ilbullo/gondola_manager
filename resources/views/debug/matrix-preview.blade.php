...
<div class="h-screen flex flex-col bg-gray-50">
    ...
    <div id="loading-modal"
         wire:loading.class.remove="flex"
         class="fixed inset-0 bg-black/50 backdrop-blur-sm items-center justify-center z-[100] hidden"
        ...
        <header class="bg-white rounded-2xl shadow-md border border-gray-200 p-4">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button wire:click="printAgencyReport" class="px-4 py-2.5 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 transition">
                        Report Agenzie
                    </button>
                    <button wire:click="$dispatch('goToAssignmentTable')" class="px-4 py-2.5 bg-yellow-500 text-white text-sm font-medium rounded-lg hover:bg-yellow-600 transition">
                        Torna alla tabella
                    </button>
                </div>
            </div>
                ...
                <div class="min-w-[1450px]">
                    <table class="w-full border-collapse text-xs">
                        ...
                        <thead class="bg-gray-50 sticky top-0 z-20 shadow-sm">
                            <tr>
                                <th scope="col" class="p-3 text-left font-bold text-gray-600 uppercase tracking-wider sticky left-0 bg-gray-50 border-b border-r border-gray-200 w-32 z-30">
                                    Licenza
                                </th>
                                <th scope="col" class="px-4 py-3 text-center font-bold text-gray-600 uppercase border-b border-gray-200">N</th>
                                <th scope="col" class="px-4 py-3 text-center font-bold text-gray-600 uppercase border-b border-gray-200">P</th>
                                <th scope="col" class="px-4 py-3 text-center font-bold text-gray-600 uppercase border-b border-gray-200">Capacità</th>
                                <th scope="col" class="px-4 py-3 text-center font-bold text-gray-600 uppercase border-b border-gray-200">Contanti</th>
                                @for ($i = 1; $i <= 25; $i++)
                                    <th scope="col" class="p-2 text-center font-bold text-gray-600 uppercase border-b border-gray-200 min-w-[3rem]">
                                        {{ $i }}
                                    </th>
                                @endfor
                            </tr>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach($matrix as $licenseKey => $license)
                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    {{-- Licenza --}}
                                    <th scope="row" class="p-3 text-sm font-bold text-blue-700 sticky left-0 bg-white border-r border-gray-200 z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] whitespace-nowrap">
                                    ...
                                    {{-- Capacità --}}
                                    <td class="px-4 py-3 text-center font-bold {{ $occupied >= $capacity ? 'text-red-700 bg-red-50' : 'text-gray-800' }}">
                                        {{ $occupied }} / {{ $capacity }}
                                    ...
                                    @foreach($works as $slotIndex => $work)
                                        ...
                                        <td
                                            class="p-1 text-center border-r border-gray-100 cursor-pointer outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-all {{ $bgClass }}
                        ...
                        <div class="flex items-center justify-between mb-2">
                            ...
                            @if($selectedWork)
                                <span class="text-xs font-medium text-blue-700">
                                    ...
                                    <button wire:click="deselectWork" class="ml-1 underline text-blue-600">deseleziona</button>
                                </span>
                            @endif
                        </div>

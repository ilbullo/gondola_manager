...
<div class="h-screen w-full flex flex-col bg-slate-100 overflow-hidden" x-data>
    ...
    <div wire:loading.delay.longer class="fixed inset-0 bg-slate-900/40 backdrop-blur-[2px] z-[1000] flex items-center justify-center">
        <div class="bg-white p-6 rounded-3xl shadow-2xl flex items-center gap-4">
            ...
            <span class="font-black uppercase text-xs tracking-widest text-slate-700">Sincronizzazione...</span>
        </div>
    </div>
</div>
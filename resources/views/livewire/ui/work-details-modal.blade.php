            ...
            >
                ...
                <div class="px-6 py-8 sm:px-10">
                    <form wire:submit="save" class="space-y-7">
                        ...
                        <div class="flex items-center justify-between bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-5 border-2 border-gray-200">
